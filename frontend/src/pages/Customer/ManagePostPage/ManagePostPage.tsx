...
const ManagePostPage: React.FC = () => {
    ...
    // Fetch posts
    const fetchPosts = useCallback(async (page: number = currentPage, size: number = pageSize) => {
        ...
        try {
            ...
            if (actualResponse && actualResponse.code === 200) {
                ...
                message.error(actualResponse?.message || "Lấy danh sách tin đăng thất bại");
                setPosts([]);
            }
        } catch (error) {
                    ...
                    <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-gray-600 mt-1">Quản lý các tin đăng phòng học của bạn</p>
                            </div>
                        </div>
                    </div>
                </div>
